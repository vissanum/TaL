...
export const SyncServicePrice =
  process.env.SYNC_SERVICE_PRICE && parseFloat(process.env.SYNC_SERVICE_PRICE)
export const SyncServicePriceUSD =
  process.env.SYNC_SERVICE_PRICE_USD &&
  parseFloat(process.env.SYNC_SERVICE_PRICE_USD)
