...
`,
  ...
  docParsePlugin: {
    ...
    pagesLimitDialog: {
      ...
      message:
        'The number of document screenshots to be rendered is too large (>{limit}). Too many images may cause slow loading and affect the understanding of the model. It is recommended to specify a page range and re-parse. Continue parsing?',
      cancel: 'Cancel',
    ...
    emptyPagesDialog: {
      ...
      message:
        'More than half of the page parsing results are empty. This may be because the PDF document consists of scanned images, and this parser can only extract text from the document. It is recommended to re-parse using the "@:{docParsePlugin.pdfScreenshotLabel}" parser.',
    },
  },
}
