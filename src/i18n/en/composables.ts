export default {
  firstVisit: {
    ...
    messageWithLogin:
      'In order to use AI models, you need to manually <b>configure the service provider</b>, or <b>log in</b> to use the model service we provide. <br>In addition, after logging in, you can also experience the real-time cloud synchronization across devices.',
    messageWithoutLogin:
      'In order to use AI models, you need to manually <b>configure the service provider</b>',
