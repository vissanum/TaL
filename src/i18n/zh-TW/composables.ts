export default {
  firstVisit: {
    ...
    messageWithLogin:
      '為了使用 AI 模型，你需要手動<b>設定服務商</b>，或<b>登入</b>以使用我們提供的模型服務。 <br>此外，登入之後還可以使用跨裝置即時雲端同步功能。',
    messageWithoutLogin:
      '為了使用 AI 模型，你需要手動<b>設定服務商</b>，或<b>登入</b>以使用我們提供的模型服務',
    cancel: '配置服務商',
    ok: '登入',
  },
  createDialog: {
  ...
  workspace: {
    ...
    confirmDeleteWorkspace:
      '確定要刪除工作區「{name}」嗎？其內部的所有對話和助手都將被刪除',
    confirmDeleteFolder:
      '確定要刪除資料夾「{name}」嗎？其內部的所有工作區都將被刪除',
    delete: '刪除',
  },
  subscriptionNotify: {
