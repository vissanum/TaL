<template>
  <q-btn v-if="pluginInfos.length" icon="sym_o_attachment">
    <q-menu>
      <q-list>
        <template v-for="{ plugin, apis } of pluginInfos" :key="plugin.id">
          ...
          >
            ...
            <q-item-section>
              ...
              <q-item-label v-if="api.description" caption lines="2">
                {{ api.description }}
              </q-item-label>
            </q-item-section>
          </q-item>
