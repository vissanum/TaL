<template>
  <q-item min-h-0 :class="{ 'bg-sec-c text-on-sec-c': selected }">
    <q-item-section avatar pr-2 min-w-0>
      <a-avatar :avatar="avatar" size="24px" />
    </q-item-section>
    <q-item-section>
      {{ model }}
    </q-item-section>
